...
test_folder = "/home/user/dataset/kaggle2020_leaf/train/0"
...
cpk_filename = configs.checkpoints + os.sep + configs.model_name + "_2020_12_27_21_35_06-checkpoint.pth.tar"
checkpoint = torch.load(cpk_filename)
